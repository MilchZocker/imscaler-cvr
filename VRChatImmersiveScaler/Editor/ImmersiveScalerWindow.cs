...
namespace VRChatImmersiveScaler.Editor
{
    ...
    public class ImmersiveScalerWindow : EditorWindow
    {
        ...
        private Component previewDescriptor;
        ...
        private static bool IsNDMFAvailable()
        {
            return System.AppDomain.CurrentDomain.GetAssemblies()
                .Any(assembly => assembly.GetName().Name == "nadena.dev.ndmf");
        }
        ...
        private void OnGUI()
        {
            ...
            if (selectedAvatar == null)
            {
                ...
                {
                    EditorGUILayout.HelpBox("Please select a ChilloutVR avatar with a Humanoid animator.", MessageType.Info);
                }
                else
                {
                    EditorGUILayout.HelpBox("ChilloutVR CCK is not installed! Please install the CCK to use this tool.", MessageType.Error);
                }
                return;
            }
            ...
            if (!showNDMFOptions)
            {
                ...
                var avatar = CVRReflectionHelper.GetCVRAvatar(selectedAvatar);
                if (avatar != null)
                {
                    // Current Stats Section
                    ImmersiveScalerUIShared.DrawCurrentStatsSection(paramProvider, scalerCore, avatar, ref showCurrentStats, isPreviewActive, originalViewPosition);
        ...
        private void ValidateAvatar()
        {
            ...
            // Check for CVRAvatar via reflection
            var descriptor = CVRReflectionHelper.GetCVRAvatar(selectedAvatar);
            if (descriptor == null)
            {
                Debug.LogError("Selected object must be a ChilloutVR avatar with CVRAvatar component!");
                selectedAvatar = null;
                scalerCore = null;
                showNDMFOptions = true;
                return;
        ...
        private void StartPreview()
        {
            ...
            if (descriptor == null)
            {
                Debug.LogError("No CVRAvatar found on avatar!");
                return;
            }
            ...
            originalViewPosition = CVRReflectionHelper.GetViewPosition(descriptor);
        ...
        private void CancelPreview()
        {
            ...
            var descriptor = selectedAvatar != null ? CVRReflectionHelper.GetCVRAvatar(selectedAvatar) : null;
            ...
            if (descriptor != null)
            {
                CVRReflectionHelper.SetViewPosition(descriptor, originalViewPosition);
        ...
        private void RescaleAvatar()
        {
            ...
            CVRReflectionHelper.SetViewPosition(descriptor, originalViewPosition * scaleRatio);
